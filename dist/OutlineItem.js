...
function (_PureComponent) {
  ...
  function OutlineItemInternal() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getDestination", function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _regenerator["default"].awrap(pdf.getDestination(item.dest));
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getPageIndex", function _callee2() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return _regenerator["default"].awrap(_this.getDestination());
            ...
            case 4:
              ...
              _context2.next = 9;
              return _regenerator["default"].awrap(pdf.getPageIndex(new _Ref["default"](ref)));
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getPageNumber", function _callee3() {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _regenerator["default"].awrap(_this.getPageIndex());
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onClick", function _callee4(event) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              _context4.next = 7;
              return _regenerator["default"].awrap(_this.getPageNumber());
