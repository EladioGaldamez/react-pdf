...
function (_PureComponent) {
  ...
  (0, _createClass2["default"])(TextLayerItemInternal, [{
    ...
    value: function getFontData(fontName) {
      var page, font;
      return _regenerator["default"].async(function getFontData$(_context) {
        while (1) {
    ...
    value: function alignTextItem() {
      ...
      return _regenerator["default"].async(function alignTextItem$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              _context2.next = 8;
              return _regenerator["default"].awrap(this.getFontData(fontName));
